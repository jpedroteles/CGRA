...
LightingScene.prototype.init = function(application) {
	...
	this.cylinder1=new MyCylinder(this,8,20);
	...
	this.cylinderAppearence.setDiffuse(1,1,1,1);
	this.cylinderAppearence.setSpecular(1,1,1,1);
	this.cylinderAppearence.setTextureWrap('CLAMP_TO_EDGE','CLAMP_TO_EDGE');
	this.cylinderAppearence.setShininess(120);	
